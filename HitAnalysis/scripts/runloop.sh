...
inputdir=/eos/user/l/lbhatt/MuDeltaPt100GeV

#pydir=$PWD/ReadSimResult/SimTrackAna/python
pydir=/afs/cern.ch/user/l/lbhatt/private/cmssw2/CMSSW_12_1_0_pre2/src/ReadSimResult/SimTrackAna/python
for i in `seq 0 9`
do
...
#  ln -s $inputdir/step1_${i}.root $PWD/step1.root 
  ...
  cmsRun $pydir/CellHitSum_cfg.py  iter=$i  geometry=D86 #-n 4 
